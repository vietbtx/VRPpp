...
if __name__ == "__main__":
    all_cmd = [
        ...
        # "python -u main.py --seed=4 --data-folder=dataset/train/uniform_N500 --algo=HGS --max-count=4",
        # "python -u main.py --seed=5 --data-folder=dataset/train/uniform_N500 --algo=HGS --max-count=4",
        # "python -u main.py --seed=6 --data-folder=dataset/train/uniform_N500 --algo=HGS --max-count=4",
        # "python -u main.py --seed=7 --data-folder=dataset/train/uniform_N500 --algo=HGS --max-count=4",
        # "python -u main.py --seed=8 --data-folder=dataset/train/uniform_N500 --algo=HGS --max-count=4",
    ]

    folders = set([cmd.split("--data-folder=")[1].split(" --max-count")[0] for cmd in all_cmd])

    for folder in folders:
        run(f"python -u init_solution.py --seed=1 --data-folder={folder}", False)
